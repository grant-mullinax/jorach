...
PUB_AND_RAVENGUARD_ROLE_MENTION = '{} {}'.format(PUG_RAIDER_ROLE_MENTION, RAVENGUARD_ROLE_MENTION),
RAID_GROUP_MENTION_ROLE_MAP = {
    RAID_GROUP_PUB: PUB_AND_RAVENGUARD_ROLE_MENTION,
    RAID_GROUP_RG1: RAVENGUARD_ROLE_MENTION,
    RAID_GROUP_RG2: RAVENGUARD_ROLE_MENTION,
    RAID_GROUP_ZG: PUB_AND_RAVENGUARD_ROLE_MENTION,
}
...
ZG_RAID_DRAWER_CATEGORY = 'ZG Raids'
...
RAID_GROUP_DRAWER_MAP = {
    ...
    RAID_GROUP_ZG: ZG_RAID_DRAWER_CATEGORY,
}
