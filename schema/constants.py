...
EMBED_TITLES = [
    ADD_IDENTITY_EMBED_TITLE,
    SELECT_MAIN_TITLE,
    SET_NICK_EMBED_TITLE,
    EDIT_IDENTITY_EMBED_TITLE,
    REMOVE_IDENTITY_EMBED_TITLE,
    LOOT_COUNCIL_EMBED_TITLE,
    RAID_CONTROL_EMBED_TITLE,
]
...
RAID_GROUP_RG2 = 'RG2'
RAID_GROUP_RG3 = 'RG3'
RAID_GROUP_RG_WEEKDAY = 'RG Weekday'
RAID_GROUP_RG_WEEKEND = 'RG Weekend'
RAID_GROUP_20 = '20 Player'
RAID_GROUP_ZG = 'ZG'
...
RAID_GROUP_MENTION_ROLE_MAP = {
    ...
    RAID_GROUP_RG_WEEKDAY: RAVENGUARD_ROLE_MENTION,
    RAID_GROUP_RG_WEEKEND: RAVENGUARD_ROLE_MENTION,
}
...
RG_WEEKDAY_RAID_DRAWER_CATEGORY = 'RG Weekday Raids'
RG_WEEKEND_RAID_DRAWER_CATEGORY = 'RG Weekend Raids'
...
RG_WEEKDAY_RAID_CHANNEL = 'RG Weekday Raid'
RG_WEEKEND_RAID_CHANNEL = 'RG Weekend Raid'
RG_WEEKDAY_LC_CHANNEL = 'RG Weekday Loot Council'
RG_WEEKEND_LC_CHANNEL = 'RG Weekend Loot Council'
...
RAID_GROUP_DRAWER_MAP = {
    ...
    RAID_GROUP_RG_WEEKDAY: RG_WEEKDAY_RAID_DRAWER_CATEGORY,
    RAID_GROUP_RG_WEEKEND: RG_WEEKEND_RAID_DRAWER_CATEGORY,
...
RAID_GROUP_CHANNEL_MAP = {
    ...
    RAID_GROUP_RG_WEEKDAY: RG_WEEKDAY_RAID_CHANNEL,
    RAID_GROUP_RG_WEEKEND: RG_WEEKEND_RAID_CHANNEL,
}
RAID_GROUP_LC_CHANNEL_MAP = {
    RAID_GROUP_RG1: RG1_LC_CHANNEL,
    RAID_GROUP_RG2: RG2_LC_CHANNEL,
    RAID_GROUP_RG_WEEKDAY: RG_WEEKDAY_LC_CHANNEL,
    RAID_GROUP_RG_WEEKEND: RG_WEEKEND_LC_CHANNEL,
}
RAID_DRAWER_ALL_CHANNELS_MAP = {
    ...
    RG_WEEKDAY_RAID_DRAWER_CATEGORY: [RG_WEEKDAY_RAID_CHANNEL, RG_WEEKDAY_LC_CHANNEL],
    RG_WEEKEND_RAID_DRAWER_CATEGORY: [RG_WEEKEND_RAID_CHANNEL, RG_WEEKEND_LC_CHANNEL],
}
